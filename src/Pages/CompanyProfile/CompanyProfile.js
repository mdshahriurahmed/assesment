...
const CompanyProfile = () => {
    return (
        <div className='px-10 bg-black py-8 px-20 mt-12'>
            <h1 className='text-4xl text-white text-center '>Company Profile</h1>
            <div className='profile_text mt-10'>
                <p className='pr-4 text-white text-justify '>BD Tools Co., Ltd. is mainly business TCT circular saw blades of research and development, production and processing, sell for building materials, aluminum alloy products, metal products, precision machinery, and hardware tools.
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-4 gap-5 justify-center justify-items-center my-8 '>
                <div >
